...
import greySvgImg from "../assets/pics/grey.svg.png";
import ezraImg from "../assets/pics/ezra.jpg.webp";
import destinyImg from "../assets/pics/destiny.png";
import dylanImg from "../assets/pics/dylan.png";
import alexImg from "../assets/pics/alex.jpg";
import francoisImg from "../assets/pics/francois.jpg";
import selfieLight from "../assets/pics/selfie_8-2.jpg";
import selfieDark from "../assets/pics/selfie_7.jpg";
...
function LandingPage() {
  ...
  const selfieSrc = theme === "light" ? selfieLight : selfieDark;
      ...
      <div className="container" id="landingpage">
        ...
        <div className="headshots-section">
          <div className="headshot-item">
            <img src={greySvgImg} alt="CGP Grey" className="headshot-image" />
            <p className="headshot-name">CGP Grey</p>
          </div>
          <div className="headshot-item">
            <img src={ezraImg} alt="Ezra Klein" className="headshot-image" />
            <p className="headshot-name">Ezra Klein</p>
          </div>
          <div className="headshot-item">
            <img src={destinyImg} alt="Destiny" className="headshot-image" />
            <p className="headshot-name">Destiny</p>
          </div>
          <div className="headshot-item">
            <img src={dylanImg} alt="Dylan Patel" className="headshot-image" />
            <p className="headshot-name">Dylan Patel</p>
          </div>
          <div className="headshot-item">
            <img src={alexImg} alt="Alex O'Connor" className="headshot-image" />
